package org.py.spring.mybatisplus.hello.doc;
...
public class MybatisPlusAutoConfiguration implements InitializingBean {
    ...
    // 类似于Mybatis，提供 SqlSessionFactory 和 SqlSessionTemplate ，提供扫描@Mapper， Bean创建成功先执行 MybatisPlusPropertiesCustomizer，在创建 SqlSessionFactory 时执行 ConfigurationCustomizer；另外增加了一些MP定制的功能
