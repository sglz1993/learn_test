...
public class ReflectUtils {
    ...
    public static Object invoke(Class targetClass, String methodName, Object targetObj, Object... param) {
        try {
            ...
            throw new NoSuchMethodException(String.format("not find method %s", methodName));
        } catch (Exception e) {
            throw new RuntimeException(e);
        }
    }
